...
const statusColor: { [key in EventStatus]: string } = {
  ...
  [EventStatus.CONTRACT_OPENED]: "bg-red-100 text-red-800",
  [EventStatus.CONTRACT_ACCEPTED]: "bg-green-100 text-green-800",
  ...
  [EventStatus.DEPOSIT_LATE]:
    "text-danger-400 bg-danger-400/10 ring-danger-400/30",
  [EventStatus.READY]: "bg-red-100 text-red-800",
  [EventStatus.DONE]: "bg-red-100 text-red-800",
  [EventStatus.INVOICE_SENT]: "bg-red-100 text-red-800",
  [EventStatus.INVOICE_OPENED]: "bg-red-100 text-red-800",
  [EventStatus.INVOICE_OVERDUE]: "bg-red-100 text-red-800",
  [EventStatus.WIN]: "bg-red-100 text-red-800",
